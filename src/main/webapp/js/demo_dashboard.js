$(function(){        
	...
	$("#clockingIn_table").dataTable();
    
	//签到点击事件
	$("#clockingInBtn").on("click", function(){
		$.post("clockingIn.do", function(data){
			setTimeout(function() {
	...
	//签退点击事件
	$("#clockingOutBtn").on("click", function(){
		$.post("clockingOut.do", {
	...
	$("#leaveBtn").on("click", function(){
		$.post("askForLeave.do", function(data){
			setTimeout(function() {
				location.href = "adminIndex.do";
			},3000);
		});
	...
	var jvm_data = [  {latLng: [50.27, 30.31], name: 'Kyiv - 1'},                                              
    ...
    $("#message_submit").click(function() {
        ...
        var message_content = '<div class="item in item-visible"><div class="image"><img src="assets/images/users/user2.jpg" alt="John Doe"></div><div class="text"><div class="heading"><a href="#">超级管理员</a><span class="date">' + myTime + '</span></div>' + message_input + '</div></div>';
